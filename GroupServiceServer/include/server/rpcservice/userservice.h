...
private:
    ...
    // fixbug::FriendServiceRpc_Stub _friendStub = new MprpcChannel();
    // fixbug::GroupServiceRpc_Stub _groupStub = new MprpcChannel();
    // fixbug::MsgServiceRpc_Stub _msgStub = new MprpcChannel();
