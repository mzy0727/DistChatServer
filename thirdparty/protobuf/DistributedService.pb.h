...
class User :
 ...
 public:
  ...
  void set_userstate(const void* value, size_t size);
  ...
  void _internal_set_userstate(const std::string& value);
...
class protobuffer :
 ...
 public:
  ...
  inline protobuffer* New() const final {
    return CreateMaybeMessage<protobuffer>(nullptr);
  }

  protobuffer* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  void set_protobufstr(const std::string& value);
  void set_protobufstr(std::string&& value);
  void set_protobufstr(const char* value);
  void set_protobufstr(const void* value, size_t size);
  std::string* mutable_protobufstr();
  std::string* release_protobufstr();
  void set_allocated_protobufstr(std::string* protobufstr);
  private:
  const std::string& _internal_protobufstr() const;
  void _internal_set_protobufstr(const std::string& value);
  std::string* _internal_mutable_protobufstr();
  public:

  // int32 protobuftype = 1;
  void clear_protobuftype();
  ::PROTOBUF_NAMESPACE_ID::int32 protobuftype() const;
  void set_protobuftype(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_protobuftype() const;
  void _internal_set_protobuftype(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 protobuftype_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_DistributedService_2eproto;
};
// -------------------------------------------------------------------
...
inline void User::set_username(std::string&& value) {
  ...
  username_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.User.username)
}
inline void User::set_username(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  username_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.User.username)
}
inline void User::set_username(const void* value, size_t size) {
  
  username_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.User.username)
}
...
inline void User::set_userstate(const std::string& value) {
  _internal_set_userstate(value);
...
inline std::string* User::mutable_userstate() {
  ...
  return _internal_mutable_userstate();
}
...
inline void User::_internal_set_userstate(const std::string& value) {
  ...
  userstate_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void User::set_userstate(std::string&& value) {
  
  userstate_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.User.userstate)
}
inline void User::set_userstate(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  userstate_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.User.userstate)
}
inline void User::set_userstate(const void* value, size_t size) {
  
  userstate_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.User.userstate)
}
inline std::string* User::_internal_mutable_userstate() {
  
  return userstate_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* User::release_userstate() {
  // @@protoc_insertion_point(field_release:fixbug.User.userstate)
  
  return userstate_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void User::set_allocated_userstate(std::string* userstate) {
  ...
  userstate_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), userstate);
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Group::_internal_groupid() const {
  return groupid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Group::groupid() const {
  // @@protoc_insertion_point(field_get:fixbug.Group.groupid)
  return _internal_groupid();
}
inline void Group::_internal_set_groupid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  groupid_ = value;
}
inline void Group::set_groupid(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void Group::set_groupname(const std::string& value) {
...
inline void Group::set_groupname(std::string&& value) {
  
  groupname_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.Group.groupname)
}
inline void Group::set_groupname(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  groupname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.Group.groupname)
}
inline void Group::set_groupname(const void* value, size_t size) {
  
  groupname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.Group.groupname)
}
...
inline void Group::set_groupdesc(const std::string& value) {
...
inline void Group::set_groupdesc(std::string&& value) {
  
  groupdesc_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.Group.groupdesc)
}
inline void Group::set_groupdesc(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  groupdesc_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.Group.groupdesc)
}
inline void Group::set_groupdesc(const void* value, size_t size) {
  
  groupdesc_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.Group.groupdesc)
}
...
inline ::fixbug::User* Group::add_groupmember() {
  ...
  return _internal_add_groupmember();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
...
inline std::string* Group::add_memberidentity() {
  ...
  return _internal_add_memberidentity();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 protobuffer::_internal_protobuftype() const {
  return protobuftype_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 protobuffer::protobuftype() const {
  // @@protoc_insertion_point(field_get:fixbug.protobuffer.protobuftype)
  return _internal_protobuftype();
}
inline void protobuffer::_internal_set_protobuftype(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  protobuftype_ = value;
}
inline void protobuffer::set_protobuftype(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void protobuffer::set_protobufstr(const std::string& value) {
  _internal_set_protobufstr(value);
...
inline std::string* protobuffer::mutable_protobufstr() {
  ...
  return _internal_mutable_protobufstr();
}
inline const std::string& protobuffer::_internal_protobufstr() const {
  return protobufstr_.GetNoArena();
}
inline void protobuffer::_internal_set_protobufstr(const std::string& value) {
  
  protobufstr_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void protobuffer::set_protobufstr(std::string&& value) {
  
  protobufstr_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.protobuffer.protobufstr)
}
inline void protobuffer::set_protobufstr(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  protobufstr_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.protobuffer.protobufstr)
}
inline void protobuffer::set_protobufstr(const void* value, size_t size) {
  
  protobufstr_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.protobuffer.protobufstr)
}
inline std::string* protobuffer::_internal_mutable_protobufstr() {
  
  return protobufstr_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* protobuffer::release_protobufstr() {
  // @@protoc_insertion_point(field_release:fixbug.protobuffer.protobufstr)
  
  return protobufstr_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void protobuffer::set_allocated_protobufstr(std::string* protobufstr) {
  ...
  protobufstr_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), protobufstr);
