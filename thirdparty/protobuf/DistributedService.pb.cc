...
class protobufferDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<protobuffer> _instance;
...
static void InitDefaultsscc_info_protobuffer_DistributedService_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_protobuffer_default_instance_;
    new (ptr) ::fixbug::protobuffer();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::protobuffer::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_protobuffer_DistributedService_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_protobuffer_DistributedService_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_DistributedService_2eproto[29];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_DistributedService_2eproto = nullptr;
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fixbug::RequestResult)},
  { 7, -1, sizeof(::fixbug::User)},
  { 15, -1, sizeof(::fixbug::FriendList)},
  { 21, -1, sizeof(::fixbug::Group)},
  { 31, -1, sizeof(::fixbug::GroupList)},
  { 37, -1, sizeof(::fixbug::ChatMessage)},
  { 49, -1, sizeof(::fixbug::protobuffer)},
  { 56, -1, sizeof(::fixbug::LoginRequest)},
  { 63, -1, sizeof(::fixbug::LoginResponse)},
  { 74, -1, sizeof(::fixbug::LoginoutRequest)},
  { 80, -1, sizeof(::fixbug::LoginoutResponse)},
  { 86, -1, sizeof(::fixbug::RegisterRequest)},
  { 93, -1, sizeof(::fixbug::RegisterResponse)},
  { 100, -1, sizeof(::fixbug::GetFriendListRequest)},
  { 106, -1, sizeof(::fixbug::GetFriendListResponse)},
  { 113, -1, sizeof(::fixbug::AddFriendRequest)},
  { 120, -1, sizeof(::fixbug::AddFriendResponse)},
  { 126, -1, sizeof(::fixbug::GetGroupListRequest)},
  { 132, -1, sizeof(::fixbug::GetGroupListResponse)},
  { 139, -1, sizeof(::fixbug::CreateGroupRequest)},
  { 147, -1, sizeof(::fixbug::CreateGroupResponse)},
  { 154, -1, sizeof(::fixbug::AddGroupRequest)},
  { 161, -1, sizeof(::fixbug::AddGroupResponse)},
  { 167, -1, sizeof(::fixbug::OneChatRequest)},
  { 175, -1, sizeof(::fixbug::OneChatResponse)},
  { 181, -1, sizeof(::fixbug::GroupChatRequest)},
  { 189, -1, sizeof(::fixbug::GroupChatResponse)},
  { 195, -1, sizeof(::fixbug::GetOfflineMsgRequest)},
  { 201, -1, sizeof(::fixbug::GetOfflineMsgResponse)},
};
...
const char descriptor_table_protodef_DistributedService_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\024GetOfflineMsgRequest\022\016\n\006userid\030\001 \001(\005\"k"
  "\n\025GetOfflineMsgResponse\022%\n\006result\030\001 \001(\0132"
  "\025.fixbug.RequestResult\022+\n\016offlinemsglist"
  "\030\002 \003(\0132\023.fixbug.ChatMessage2\304\001\n\016UserServ"
  "iceRpc\0224\n\005Login\022\024.fixbug.LoginRequest\032\025."
  "fixbug.LoginResponse\022=\n\010Loginout\022\027.fixbu"
  "g.LoginoutRequest\032\030.fixbug.LoginoutRespo"
  "nse\022=\n\010Register\022\027.fixbug.RegisterRequest"
  "\032\030.fixbug.RegisterResponse2\242\001\n\020FriendSer"
  "viceRpc\022L\n\rGetFriendList\022\034.fixbug.GetFri"
  "endListRequest\032\035.fixbug.GetFriendListRes"
  "ponse\022@\n\tAddFriend\022\030.fixbug.AddFriendReq"
  "uest\032\031.fixbug.AddFriendResponse2\343\001\n\017Grou"
  "pServiceRpc\022I\n\014GetGroupList\022\033.fixbug.Get"
  "GroupListRequest\032\034.fixbug.GetGroupListRe"
  "sponse\022F\n\013CreateGroup\022\032.fixbug.CreateGro"
  "upRequest\032\033.fixbug.CreateGroupResponse\022="
  "\n\010AddGroup\022\027.fixbug.AddGroupRequest\032\030.fi"
  "xbug.AddGroupResponse2\333\001\n\rMsgServiceRpc\022"
  ":\n\007OneChat\022\026.fixbug.OneChatRequest\032\027.fix"
  "bug.OneChatResponse\022@\n\tGroupChat\022\030.fixbu"
  "g.GroupChatRequest\032\031.fixbug.GroupChatRes"
  "ponse\022L\n\rGetOfflineMsg\022\034.fixbug.GetOffli"
  "neMsgRequest\032\035.fixbug.GetOfflineMsgRespo"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_DistributedService_2eproto_sccs[29] = {
  ...
  &scc_info_RequestResult_DistributedService_2eproto.base,
  &scc_info_User_DistributedService_2eproto.base,
  &scc_info_protobuffer_DistributedService_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_DistributedService_2eproto = {
  &descriptor_table_DistributedService_2eproto_initialized, descriptor_table_protodef_DistributedService_2eproto, "DistributedService.proto", 2976,
  &descriptor_table_DistributedService_2eproto_once, descriptor_table_DistributedService_2eproto_sccs, descriptor_table_DistributedService_2eproto_deps, 29, 0,
  schemas, file_default_instances, TableStruct_DistributedService_2eproto::offsets,
  file_level_metadata_DistributedService_2eproto, 29, file_level_enum_descriptors_DistributedService_2eproto, file_level_service_descriptors_DistributedService_2eproto,
};
...
User::User(const User& from)
  ...
  if (!from._internal_userstate().empty()) {
    userstate_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.userstate_);
  }
...
// @@protoc_insertion_point(message_clear_start:fixbug.User)
  ...
  userstate_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  userid_ = 0;
  _internal_metadata_.Clear();
}
...
void User::InternalSwap(User* other) {
  ...
  username_.Swap(&other->username_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  userstate_.Swap(&other->userstate_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
void protobuffer::InitAsDefaultInstance() {
}
...
protobuffer::protobuffer()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.protobuffer)
}
protobuffer::protobuffer(const protobuffer& from)
  ...
  if (!from._internal_protobufstr().empty()) {
    protobufstr_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.protobufstr_);
  }
  protobuftype_ = from.protobuftype_;
  // @@protoc_insertion_point(copy_constructor:fixbug.protobuffer)
}

void protobuffer::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_protobuffer_DistributedService_2eproto.base);
  protobufstr_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  protobuftype_ = 0;
}
...
const protobuffer& protobuffer::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_protobuffer_DistributedService_2eproto.base);
  return *internal_default_instance();
}
...
// @@protoc_insertion_point(message_clear_start:fixbug.protobuffer)
  ...
  protobufstr_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  protobuftype_ = 0;
  _internal_metadata_.Clear();
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          protobuftype_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // bytes protobufstr = 2;
...
::PROTOBUF_NAMESPACE_ID::uint8* protobuffer::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void protobuffer::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.protobuffer)
  GOOGLE_DCHECK_NE(&from, this);
  const protobuffer* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<protobuffer>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.protobuffer)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.protobuffer)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.protobuffer)
  ...
  if (from.protobufstr().size() > 0) {

    protobufstr_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.protobufstr_);
  }
  if (from.protobuftype() != 0) {
    _internal_set_protobuftype(from._internal_protobuftype());
  }
}

void protobuffer::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.protobuffer)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void protobuffer::InternalSwap(protobuffer* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  protobufstr_.Swap(&other->protobufstr_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
template<> PROTOBUF_NOINLINE ::fixbug::protobuffer* Arena::CreateMaybeMessage< ::fixbug::protobuffer >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::protobuffer >(arena);
}
