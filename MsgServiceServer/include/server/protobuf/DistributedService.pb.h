...
class GroupUser :
 ...
 public:
  ...
  void clear_state();
  ::fixbug::STATE state() const;
  void set_state(::fixbug::STATE value);
  private:
  ::fixbug::STATE _internal_state() const;
  void _internal_set_state(::fixbug::STATE value);
  public:

  // .fixbug.ROLE role = 5;
  void clear_role();
  ::fixbug::ROLE role() const;
  void set_role(::fixbug::ROLE value);
  private:
  ::fixbug::ROLE _internal_role() const;
  void _internal_set_role(::fixbug::ROLE value);
  public:
...
inline ::fixbug::STATE GroupUser::_internal_state() const {
  return static_cast< ::fixbug::STATE >(state_);
}
inline ::fixbug::STATE GroupUser::state() const {
  // @@protoc_insertion_point(field_get:fixbug.GroupUser.state)
  return _internal_state();
}
inline void GroupUser::_internal_set_state(::fixbug::STATE value) {
  
  state_ = value;
}
inline void GroupUser::set_state(::fixbug::STATE value) {
  _internal_set_state(value);
...
inline ::fixbug::ROLE GroupUser::_internal_role() const {
  return static_cast< ::fixbug::ROLE >(role_);
}
inline ::fixbug::ROLE GroupUser::role() const {
  // @@protoc_insertion_point(field_get:fixbug.GroupUser.role)
  return _internal_role();
}
inline void GroupUser::_internal_set_role(::fixbug::ROLE value) {
  
  role_ = value;
}
inline void GroupUser::set_role(::fixbug::ROLE value) {
